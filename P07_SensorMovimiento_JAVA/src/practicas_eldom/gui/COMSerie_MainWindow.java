...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {	
		...
		JRadioButtonMenuItem P7_PIR = new JRadioButtonMenuItem("Sensor de Movimiento PIR");
		P7_PIR.addActionListener(Select_Practica);
		mnPractica_7.add(P7_PIR);
