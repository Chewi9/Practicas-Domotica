...
public class CommSerie {
	...
	public void writeStringSerial(String msg) throws SerialPortException {
		if (serialPort != null) 
			if (serialPort.isOpened()) // Si nos encontramos el puerto serie abierto
				serialPort.writeString(msg); // Escribimso el mensaje que debe aparecer en el puerto
	}
}
