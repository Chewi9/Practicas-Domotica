...
//	private 	SerialPort 				serialPort;	
	...
	public P02_ElDom_MainWindow() {		
      ...
      //display date time to status bar
		...
		JLabel tituloSeleccion = new JLabel("Seleccionar apartado de la práctica 1:");
		    ...
		    public void actionPerformed(ActionEvent e) {
		        try { 
		            switch (selectorModo.getSelectedIndex()) { 
		                case 0: // Corresponde a Apartado 1
		                    commSerie.writeStringSerial("#1");
		                    break;

		                case 1: // Corresponde a Apartado 2
		                    commSerie.writeStringSerial("#2");
		                    break;

		                case 2: // Corresponde a Apartado 3
