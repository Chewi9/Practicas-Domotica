...
enum{ // Enum para los registros de los botones
	MB_BTN1,
	MB_BTN2,
	MB_BTN_OPT,
	MB_I_DISCRETE
...
extern uint16_t	Cregs[MB_O_COILS]; // Memoria para acordarse de las bombillas
extern uint16_t Dregs[MB_I_DISCRETE]; // Memoria para acordarse del estado de los botones
// Dregs sirve para guardar un 1 o 0 dependiendo del estado del botón, y asi detectar si está pulsado o no
