...
void Init_RTU_Modbus()
{
	...
	*/
	...
	mbs.set_BankDiscrete(Dregs, MB_I_DISCRETE);
...
void RTU_ModBus()
{
	// Sirve para leer el estado en todo momento y lo copia en la casilla de cada uno
	Dregs[MB_BTN1] = (mbDomoboard.BOTON1.Sensor->valor != mbDomoboard.BOTON1.Sensor->valor_Df) ? 1 : 0;
	Dregs[MB_BTN2] = (mbDomoboard.BOTON2.Sensor->valor != mbDomoboard.BOTON2.Sensor->valor_Df) ? 1 : 0;
	Dregs[MB_BTN_OPT] = (mbDomoboard.BTN_OPT.Sensor->valor != mbDomoboard.BTN_OPT.Sensor->valor_Df) ? 1 : 0;
