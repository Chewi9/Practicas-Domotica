...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {	
		...
		JMenu mnPrctica_9 = new JMenu("Práctica 9 - Sensores Analógicos");
		mnSeleccionarPrctica.add(mnPrctica_9);
		
		JRadioButtonMenuItem P9_SensoresAnalogicos = new JRadioButtonMenuItem("Sensores");
		P9_SensoresAnalogicos.addActionListener(Select_Practica);
		mnPrctica_9.add(P9_SensoresAnalogicos);
		...
		practicaSel.add(P9_SensoresAnalogicos);
