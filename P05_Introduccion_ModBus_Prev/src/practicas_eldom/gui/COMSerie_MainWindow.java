...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {		
		...
		// Boton ON RELE
		JButton btnReleOn = new JButton("ON RELE");
		btnReleOn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String slaveAdd = "1";
				String val = "1";		//Valor a escribir en el registro --> ON
				String reg = Integer.toString(MB_Registers.MB_RELE); 	//Registro ModBus a escribir
				String[] args = {slaveAdd, String.valueOf(Const_Modbus.WRITE_COIL), reg, val};
		...
		btnReleOn.setBounds(80, 60, 120, 30);
		panel_1.add(btnReleOn);
		
		
		// Boton OFF RELE
		JButton btnReleOff = new JButton("OFF RELE");
		btnReleOff.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String slaveAdd = "1";
				String val = "0";		//Valor a escribir en el registro --> OFF
				String reg = Integer.toString(MB_Registers.MB_RELE); 	//Registro ModBus a escribir
				String[] args = {slaveAdd, String.valueOf(Const_Modbus.WRITE_COIL), reg, val};
		...
		btnReleOff.setBounds(220, 60, 120, 30);
		panel_1.add(btnReleOff);
		
		
		// Boton ON TRIAC
		JButton btnTriacOn = new JButton("ON TRIAC");
		btnTriacOn.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String slaveAdd = "1";
				String val = "1";		//Valor a escribir en el registro --> ON
				String reg = Integer.toString(MB_Registers.MB_TRIAC); 	//Registro ModBus a escribir
				String[] args = {slaveAdd, String.valueOf(Const_Modbus.WRITE_COIL), reg, val};
		...
		btnTriacOn.setBounds(80, 110, 120, 30);
		panel_1.add(btnTriacOn);
		
		
		// Boton OFF TRIAC
		JButton btnTriacOff = new JButton("OFF TRIAC");
		btnTriacOff.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				String slaveAdd = "1";
				String val = "0";		//Valor a escribir en el registro --> OFF
		...
		btnTriacOff.setBounds(220, 110, 120, 30);
		panel_1.add(btnTriacOff);
