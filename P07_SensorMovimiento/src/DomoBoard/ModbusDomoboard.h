...
enum{
	...
	MB_PIR_ACTIVO,		// Activar 1, desactivar 0 detección PIR desde maestro
	MB_PIR_TIEMPO,		// Tiempo activación PIR en ms
	MB_PIR_TIEMPO_TIMER, // Instante de la última detección

	MB_A_REGS			// Total de registros Analógicos

};

// Ponemos MB_A_REGS al final para que nos de el número de registros al añadir nuevos registros
