...
enum{
	...
	MB_FOTORES_HI,      // Umbral alto
	MB_FOTORES_LO,      // Umbral bajo
	MB_FOTOTRans,       // Valor Fototr          
...
enum{
	...
	MB_FOTORES,			// Fotoresistencia
	MB_FOTOTR,			// FotoTransistor
...
public:
	...
	TmbSensor	FOTORES;			// Fotoresistencia
	TmbSensor	FOTOTR;				// FotoTransistor
	TmbSensor	TEMP;				// Sensor de temperatura
