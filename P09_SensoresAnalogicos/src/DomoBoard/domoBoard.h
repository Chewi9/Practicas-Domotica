...
#define     FotoRes                 A0 	  		// Fotoresistencia
#define     FotoTr                  A5          // FotoTransistor
...
public:
	...
	tsSensor		FOTORES;			// Fotoresistencia
	tsSensor		FOTOTR;				// FotoTransistor
	tsSensor		TEMP;				// Sensor de temperatura
