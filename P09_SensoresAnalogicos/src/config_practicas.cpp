...
void Config_P9_Analogicos(void);
...
TPractica Practicas[] = {
	...
	{0x90, "P9_ANALOGICOS", Config_P9_Analogicos}
};
...
void Config_P9_Analogicos(void) {
	...
	// Fotoresistencia activa rele
	mbDomoboard.FOTORES.mbSensorEvent = mbFotoresInterruptor;
	mbDomoboard.FOTORES.mbActuators.push(&(mbDomoboard.RELE));

	// Fototransistor activa triac
	mbDomoboard.FOTOTR.mbSensorEvent = mbFotoTrans;
	mbDomoboard.FOTOTR.mbActuators.push(&(mbDomoboard.TRIAC));
