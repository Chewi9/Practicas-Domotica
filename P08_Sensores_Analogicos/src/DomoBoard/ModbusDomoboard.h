...
// Registros para sensores analógicos, solo lectura desde el maestro ModBus, el esclavo escribe el valor leido y el maestro lo consulta
enum {
	MB_POT1,
	MB_POT2,
	MB_ANA_REGS
...
extern uint16_t ANARegs[MB_ANA_REGS];		//Registros para "Analog Input Registers"
