...
typedef enum{
	...
	BANK_HOLDING_REGS,
	BANK_ANALOG_INPUTS // Solo para lectura del maestro, el esclavo escribe el valor leido en el registro y el maestro lo consulta
}BankType;
...
class ModbusSlave {
	private:
		...
		uint16_t 	*ANARegs = NULL;
		uint16_t 	N_ANARegs = 0;
